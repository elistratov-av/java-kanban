...
class EpicTest {
    ...
    void allSubtasksNew() {
        ...
        tm.create(new Subtask("Subtask2", TaskStatus.NEW, today.plusHours(1), Duration.ofMinutes(1), epic));
    ...
    void allSubtasksDone() {
        ...
        tm.create(new Subtask("Subtask2", TaskStatus.DONE, today.plusHours(1), Duration.ofMinutes(1), epic));
    ...
    void someSubtasksInProgress() {
        ...
        LocalDateTime today = LocalDateTime.now();
        tm.create(new Subtask("Subtask1", TaskStatus.NEW, today, Duration.ofMinutes(1), epic));
        tm.create(new Subtask("Subtask2", TaskStatus.IN_PROGRESS, today.plusHours(1), Duration.ofMinutes(1), epic));
